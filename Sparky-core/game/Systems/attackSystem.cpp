...
//	//fireballSprite->setSize(math::vec2(0.5f, 0.5f));
//	//	
//	////fireball->addComponent(new SpriteComponent(fireballSprite));
//	////fireball->addComponent(new RectangleAppearance(fireballSprite->getSize().x, fireballSprite->getSize().y));
//
//	//SystemManager::addRenderedSprites.push_back(fireballSprite);
//	////Level0::entities.push_back(fireball);
//
//	//resetAttack(attackComp);
//}
//
